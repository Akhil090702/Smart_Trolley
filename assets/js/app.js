...
document.addEventListener('DOMContentLoaded', function () {
  var addtoCart = document.querySelectorAll('.dish-add-btn');
  addtoCart.forEach(function (button) {
    button.addEventListener('click', function () {
      var itemData = button.dataset.item;
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkcap_website"] = self["webpackChunkcap_website"] || [];
